-- Fix: Remove confirmed_at from auth.users UPDATE
-- confirmed_at is a generated column in auth.users and cannot
-- be updated manually. Only email_confirmed_at should be set.
