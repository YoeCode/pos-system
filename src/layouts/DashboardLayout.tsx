                  ...
                  <NavLink
                    ...
                    className={({ isActive }) =>
                      `flex items-center gap-3 px-4 py-2.5 text-sm font-medium transition-all ${
                        isActive
                          ? 'text-text-primary'
                          : 'text-text-muted hover:text-text-primary hover:underline underline-offset-2'
                      }`
                    }
                  >
          ...
          <div className="h-full px-3 lg:px-6 flex items-center gap-2 lg:gap-4">
            ...
            <div className="flex items-center gap-3">
              <button
                ...
                className="h-8 w-8 flex items-center justify-center rounded-lg hover:bg-background text-text-muted hover:text-text-primary transition-colors"
